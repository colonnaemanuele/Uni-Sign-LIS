...
class Uni_Sign(nn.Module):
    ...
    @torch.no_grad()
    def generate(self, pre_compute_item, max_new_tokens=100, num_beams=1, 
             do_sample=False, top_k=None, top_p=None, repetition_penalty=None):
        ...
        out = self.mt5_model.generate(**generate_kwargs)
        return out
